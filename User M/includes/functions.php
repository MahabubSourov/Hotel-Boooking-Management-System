...
// Fix image path - ensures images always use correct SITE_URL
function fixImagePath($imagePath)
{
    ...
    // If it's already a full URL (http:// or https://), check if it needs fixing
    if (preg_match('/^https?:\/\//', $imagePath)) {
        // Replace old WBT path with correct path
        $imagePath = str_replace('/WBT/hotel_booking/', '/hotel_booking/', $imagePath);
        // Replace localhost URLs with current SITE_URL
        $imagePath = preg_replace('/https?:\/\/localhost\/hotel_booking/', SITE_URL, $imagePath);
        return $imagePath;
    }

    // If it starts with assets/ or /, make it a full URL
