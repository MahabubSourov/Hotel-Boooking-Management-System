    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem;">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                            <label class="payment-option"
                                ...
                                <img src="<?php echo fixImagePath(SITE_URL . '/assets/images/card.png'); ?>"
                            ...
                            <label class="payment-option"
                                ...
                                <img src="<?php echo fixImagePath(SITE_URL . '/assets/images/bkash.png'); ?>"
                                    style="width: 60px; height: 60px; margin: 0 auto 0.5rem; border-radius: 0.5rem;"
                                    alt="bKash">
                            ...
                            <label class="payment-option"
                                ...
                                <img src="<?php echo fixImagePath(SITE_URL . '/assets/images/nagad.png'); ?>"
                                    style="width: 60px; height: 60px; margin: 0 auto 0.5rem; border-radius: 0.5rem;"
                                    alt="Nagad">
        ...
        <div>
            <div style="background: white; padding: 1.5rem; border-radius: 1rem; box-shadow: var(--shadow-md);">
                <img src="<?php echo fixImagePath($hotel['hotel_image']); ?>"
