        ...
        <div class="grid grid-3">
            <?php if ($featuredHotels->num_rows > 0): ?>
                <?php while ($hotel = $featuredHotels->fetch_assoc()): ?>
                    <div class="card">
                        <img src="<?php echo fixImagePath($hotel['image']) ?: 'https://via.placeholder.com/400x250?text=Hotel+Image'; ?>"
        ...
        <div class="grid grid-3">
            ...
            while ($dest = $destinations->fetch_assoc()):
                ...
                <a href="<?php echo SITE_URL; ?>/hotels.php?destination=<?php echo $dest['id']; ?>" class="card"
                    ...
                    <img src="<?php echo fixImagePath($dest['image']) ?: 'https://via.placeholder.com/400x250?text=' . urlencode($dest['name']); ?>"
